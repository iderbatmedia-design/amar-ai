...
import { runSalesAgent, runClassifier } from '@/app/lib/openai'
...
async function sendMetaMessage(accessToken: string, recipientId: string, message: string, platform: string) {
  const url = platform === 'page'
